            ...
            >
                ...
                <div className='flex justify-between items-center gap-2 w-full'>
                    ...
                    {postedBy?._id === user?.googleId && (
                        ...
                        type='button' className="bg-white opacity-70 flex justify-end flex-col items-end p-2 hover:opacity-100 text-dark font-bold text-base rounded-3xl hover:shadow-md outline-none">
                            <AiTwotoneDelete />
                        </button>
                    )}
                </div>
